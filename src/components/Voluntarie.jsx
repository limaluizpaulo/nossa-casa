            ...
            <div className="beneficios-grid">
              ...
              <div className="beneficio-item">
                ...
                <div>
                  ...
                  <p>Certificados de voluntáriado e referências para seu currículo</p>
                </div>
              </div>
            </div>
          </div>
              ...
              {depoimentos.map((depoimento, index) => (
                <div key={index} className="depoimento-card">
                  ...
                  <div className="depoimento-autor">
                    ...
                    <span>{depoimento.area} • {depoimento.tempo} de voluntáriado</span>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="voluntario-form mt-48">
            ...
            <form onSubmit={handleSubmit} className="form-voluntario">
              ...
              <div className="form-section">
                <h4>Sua motivação</h4>
                <div className="form-field">
                  <label htmlFor="experiencia">Experiência anterior com voluntáriado</label>
                  <textarea
                    id="experiencia"
                    name="experiencia"
